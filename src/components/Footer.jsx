    ...
    <>
      <footer className="site-footer">
        ...
        <div className="copyright">
          <p>&copy; {currentYear} The Voice Simulator - Tous droits réservés</p>
        </div>
          ...
          <div className="modal-content">
            ...
            <div className="legal-content">
              <p>
                ...
                https://chrstn67.github.io/thevoice-simulator/ l'identité des
              ...
              <p>
                ...
                https://chrstn67.github.io/thevoice-simulator/. Christian
                HUMBERT décline toute responsabilité quant à l'utilisation qui
                pourrait être faite des informations et contenus présents sur
                https://chrstn67.github.io/thevoice-simulator/. Christian
                HUMBERT s'engage à sécuriser au mieux le site
                https://chrstn67.github.io/thevoice-simulator/, cependant sa
              ...
              <p>
                ...
                l'utilisateur du
                sitehttps://chrstn67.github.io/thevoice-simulator/ dispose d'un
              ...
              <p>
                ...
                https://chrstn67.github.io/thevoice-simulator/ contient des
                liens hypertextes vers d'autres sites et dégage toute
                responsabilité à propos de ces liens externes ou des liens créés
                par d'autres sites
                vershttps://chrstn67.github.io/thevoice-simulator/.
              </p>

              <p>
                6 - Droit applicable et attribution de juridiction : Tout litige
                en relation avec l'utilisation du site
                https://chrstn67.github.io/thevoice-simulator/ est soumis au
